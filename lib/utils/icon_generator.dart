...
/// It's for demonstration purposes only and would be replaced with actual icon files
class IconGenerator {
  ...
  static Future<void> generateSplashIcon() async {
    final recorder = ui.PictureRecorder();
    final canvas = Canvas(recorder);
    ...
    final directory = await getApplicationDocumentsDirectory();
    final file = File('${directory.path}/splash_icon.png');
    await file.writeAsBytes(buffer);
